    ...
    if request.method == 'GET':
        ...
        response = client.models.generate_content(
            model="gemini-3.5-flash", contents=f"Hi I am {n7},I want to create a anime story in the comics form"
                                               ...
                                               f"pictures of every characters with the expression"
                                               ...
                                               f"more intresting and mention every character name along with their dialogue the story theme will be {n4} the main"
                                               ...
                                               f"format use cartoon character's pictures and"
                                               ...
                                               f"as a result and give option to download all episodes "
                                               f"in one click")
